...
namespace CsvConvertExample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("- Reading person data from csv : " + csvReadingPath);
            var people = csvProcessor.ReadCsv(csvReadingPath);
            Console.WriteLine("- \"" + csvReadingPath + "\" file read successfully. We have total " + people.Count + " people.");
            ...
            Console.WriteLine("- All operations are complete. Now press any key to exit.");
